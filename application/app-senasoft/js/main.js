...
function hablar_imagen(acento,lemguaje,texto_hablar) {
    ...
    const subscriptionKey = '609bcbd8f70d4b89aad75513331eb05e'; // Reemplaza con tu clave de suscripción
...
function identifyImageURL(imageUrl) {
    const predictionUrl = "https://sambraulio.cognitiveservices.azure.com/customvision/v3.0/Prediction/b187e107-2def-458f-aa0b-922259b3a705/classify/iterations/clasificacion-v1/url";
...
function identifyImageFILE() {
    ...
    const apiUrl = "https://sambraulio.cognitiveservices.azure.com/customvision/v3.0/Prediction/b187e107-2def-458f-aa0b-922259b3a705/classify/iterations/clasificacion-v1/image";
...
async function getAnalisis(img) {
    const key = '609bcbd8f70d4b89aad75513331eb05e';
    const endpoint = 'https://sambraulio.cognitiveservices.azure.com/';
    const headers = {
        "Ocp-Apim-Subscription-Key": key,
        "Content-Type": "application/json"
    };
...
function getDeteccionFace(img) {
    const key = "89fdca9aafa54df2b50e5d033929fdda";    
    const endpoint = "https://face-adso-2023.cognitiveservices.azure.com/";
...
function orc(img) {
    var key = "6fe16dac8e9e40958cdebf866727865a";
    var endpoint = "https://computer-vision-adso.cognitiveservices.azure.com/";
