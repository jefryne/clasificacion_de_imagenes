...
function crearRegistros(nombre_usuario,telefono,correo,telefono,correo) {
    data = {
    ...
    .then(data =>{
        ...
        if(accion == "entidad"){
            ...
            boton_sutmit.addEventListener("click",()=>{
                crearRegistros(input_nombre.value,input_telefono.value,input_correo.value,input_telefono.value,input_correo.value)
            })
        }
    })
    .catch(error => {
